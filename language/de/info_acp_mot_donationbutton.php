...
$lang = array_merge($lang, [
	...
	'ACP_MOT_DONBUTTON_SETTINGS_EXPLAIN'	=> 'Hier kannst du auswählen, an welcher Stelle im Forum der Donation Button angezeigt werden soll und dessen
												Ausrichtung in seinem Anzeigefeld auswählen.<br>
												Wichtig ist, dass du den von deinem Zahlungsdienstleister erhaltenen Code im entsprechenden Eingabefeld eingibst,
												...
												Denke bitte daran, unter ´Berechtigungen´ noch einzustellen, welche Nutzer/Nutzergruppen den Donation Button
												sehen und damit auch benutzen dürfen. Standardmäßig wird den Benutzer-Rollen ´Standard-Funktionalität´ und
												´Volle Funktionalität´ diese Berechtigung während der Installation erteilt. Passe die Berechtigungen anderer
												Benutzer-Rollen entsprechend deiner Wünsche an.',
	// Position vars
	'ACP_MOT_DONBUTTON_POSITION'			=> 'Position des Donation Button',
	'ACP_MOT_DONBUTTON_POSITION_EXP'		=> 'Hier kannst du auswählen, an welcher Stelle der Donation Button angezeigt werden soll.',
	...
	'ACP_MOT_DONBUTTON_ALIGN_EXP'			=> 'Hier kannst du auswählen, ob der Donation Button links, rechts oder zentriert im Anzeigefeld dargestellt werden soll.',
	...
	'ACP_MOT_DONBUTTON_BUTTON_HTML_EXP'		=> 'Hier kannst du den HTML-Code für den Donation Button eingeben. Dieser HTML-Code wird dir in der Regel vom
												Zahlungsdienstleister bereitgestellt.',
	'ACP_MOT_DONBUTTON_TINY_TEXT'			=> 'Hinweistext',
	'ACP_MOT_DONBUTTON_TINY_TEXT_EXP'		=> 'Hier kannst du - musst du aber nicht - einen kurzen Hinweistext (max. 50 Zeichen) eingeben, der vor dem
												Donation Button angezeigt wird.',
	// Support and version
	'ACP_MOT_DONBUTTON_SUPPORT'				=> 'Wenn du die Entwicklung der Erweiterung ´Donation Button´ unterstützen möchtest, kannst du das hier tun:<br>',
